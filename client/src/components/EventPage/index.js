...
class EventPage extends React.Component {
    ...
    async componentDidMount() {
        ...
        this.setState({
            ...
            event_utc: eventData.data.event_utc,
        ...
        if (this.state.event_name) {
            return (
                <div>
                    ...
                    <div className="p-3">
                        <p><span className="font-weight-bold">Date:</span> <Moment date={this.state.event_utc} format="MMMM Do YYYY" /></p>
                        <p><span className="font-weight-bold">Time:</span> TIME TO GO HERE </p>
